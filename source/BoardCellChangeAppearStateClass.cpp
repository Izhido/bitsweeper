...
BoardCellChangeAppearStateClass::BoardCellChangeAppearStateClass()
: StateClass()
{
}
...
void BoardCellChangeAppearStateClass::Draw(CommonDataClass* CommonData)
{
	...
	for(j = Top; j < Bottom; j++)
	{
		...
		for(i = CommonData->LeftCell; i < CommonData->RightCell; i++)
		{
			...
			{
				glVertex3v16(CommonData->BoardCellXCoordinates[x + 1], 0, CommonData->BoardCellZCoordinates[z + 1]);
				glVertex3v16(CommonData->BoardCellXCoordinates[x + 1], 0, CommonData->BoardCellZCoordinates[z + 1] + ((10 - Count + 1) * (CommonData->BoardCellZCoordinates[z + 2] - CommonData->BoardCellZCoordinates[z + 1]) / 10));
				glVertex3v16(CommonData->BoardCellXCoordinates[x + 2], 0, CommonData->BoardCellZCoordinates[z + 1] + ((10 - Count + 1) * (CommonData->BoardCellZCoordinates[z + 2] - CommonData->BoardCellZCoordinates[z + 1]) / 10));
				glVertex3v16(CommonData->BoardCellXCoordinates[x + 2], 0, CommonData->BoardCellZCoordinates[z + 1]);
			};
			k++;
			x = x + 3;
		...
		for(i = CommonData->LeftCell; i < CommonData->RightCell; i++)
		{
			...
			if(t >= 0)
			{
				...
				if(k == CommonData->CellBeingChanged)
				{
					...
					glVertex3v16(CommonData->BoardCellXCoordinates[x + 1], 0, CommonData->BoardCellZCoordinates[z + 2] - (Count * (CommonData->BoardCellZCoordinates[z + 2] - CommonData->BoardCellZCoordinates[z + 1]) / 10));
					glTexCoord2t16(inttot16(0), inttot16(16));
					glVertex3v16(CommonData->BoardCellXCoordinates[x + 1], 0, CommonData->BoardCellZCoordinates[z + 2]);
					glTexCoord2t16(inttot16(16), inttot16(16));
					glVertex3v16(CommonData->BoardCellXCoordinates[x + 2], 0, CommonData->BoardCellZCoordinates[z + 2]);
					glTexCoord2t16(inttot16(16), inttot16(0));
					glVertex3v16(CommonData->BoardCellXCoordinates[x + 2], 0, CommonData->BoardCellZCoordinates[z + 2] - (Count * (CommonData->BoardCellZCoordinates[z + 2] - CommonData->BoardCellZCoordinates[z + 1]) / 10));
				} else
				{
					glTexCoord2t16(inttot16(0), inttot16(0));
					glVertex3v16(CommonData->BoardCellXCoordinates[x + 1], 0, CommonData->BoardCellZCoordinates[z + 1]);
