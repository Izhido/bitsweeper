...
LegendAppearStateClass::LegendAppearStateClass()
: StateClass()
{
}
...
void LegendAppearStateClass::Draw(CommonDataClass* CommonData)
{
	...
	glVertex3f(0.1 - CommonData->LegendX, 0.0, 0.012 + (Count * 0.013 / 4.0));
	glTexCoord2t16(inttot16(512), inttot16(16));
	glVertex3f(0.5 - CommonData->LegendX, 0.0, 0.012 + (Count * 0.013 / 4.0));
	...
	glVertex3f(0.5 - CommonData->LegendX, 0.0, 0.012 + (Count * 0.013 / 4.0));
	glTexCoord2t16(inttot16(512), inttot16(16));
	glVertex3f(0.9 - CommonData->LegendX, 0.0, 0.012 + (Count * 0.013 / 4.0));
	glTexCoord2t16(inttot16(512), inttot16(0));
